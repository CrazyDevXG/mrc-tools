...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/user-bg.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">User Application</span>
				...
				<form class="login100-form validate-form p-b-35 p-t-15" action="check-login" method="post">						
					...
					<div class="wrap-input100 validate-input" data-validate="กรุณาระบุ ชื่อผู้ใช้ ">
						<input class="input100" type="text" name="Me_ID"  placeholder="E-mail" required >
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="กรุณาระบุ รหัสผ่าน">
						<input class="input100" type="password" name="Me_Pass" placeholder="Password" required >
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>	
					<a href="#" class="text-secondary m-3 float-right"> ฉันลืมรหัสผ่าน..?</a>		
					<div class="container-login100-form-btn m-t-80">
						<button class="login100-form-btn" name="btn-login-user">
