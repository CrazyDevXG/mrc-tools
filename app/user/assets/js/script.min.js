...
$(document).ready(function () {
    ...
    $("#search-friends").on("keyup", function () {
      ...
      $(".userlist-box .media-body .chat-header").each(function () {
        ...
        $(this)
          ...
          [-1 !== t.indexOf(e) ? "show" : "hide"]();
      });
    }),
    $(".displayChatbox").on("click", function () {
      if ("right" == $(".mrc").attr("vertical-placement"))
        var e = { direction: "left" };
      else var e = { direction: "right" };
  ...
  $("#styleSelector").append(
    ...
    ' </li><li><p class="selector-title">Main layouts</p></li><li>'+
    '<div class="theme-color">'+
    '<a href="#" class="navbar-theme" navbar-theme="themelight1">'+
    '<span class="head"></span><span class="cont"></span></a>'+
    '<a href="#" class="navbar-theme" navbar-theme="theme1"><span class="head"></span>'+
   ' <span class="cont"></span></a></div></li></ul>'+
    '<div class="style-cont m-t-10"><ul class="nav nav-tabs  tabs" role="tablist">'+
    '<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sel-layout" role="tab">Layout colors</a></li>'+
    '</ul>'+
   ' <div class="tab-content tabs"><div class="tab-pane active" id="sel-layout" role="tabpanel">'+
   '<ul><li class="theme-option"><div class="checkbox-fade fade-in-primary"><label>'+
   '<input type="checkbox" value="false" id="sidebar-position" name="sidebar-position" checked>'+
   '<span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"></i></span><span>Fixed Sidebar Position</span></label></div></li>'+
   '<li class="theme-option"><div class="checkbox-fade fade-in-primary">'+
   '<label><input type="checkbox" value="false" id="header-position" name="header-position" checked><span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"></i></span><span>Fixed Header Position</span></label></div></li></ul></div>'+
   '<ul><li><p class="selector-title">Header Brand color</p></li>'+
   '<li class="theme-option"><div class="theme-color">'+
   ...
   '</div></li><li><p class="selector-title">Header color</p></li><li class="theme-option"><div class="theme-color">'+
   ...
   '</div></li><li><p class="selector-title">Active link color</p></li><li class="theme-option"><div class="theme-color">'+
      ...
      '</div></li><li><p class="selector-title">Menu Caption Color</p></li><li class="theme-option"><div class="theme-color">'+
