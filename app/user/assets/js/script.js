...
$("#styleSelector").append(
  "" +
    ...
    "<ul>" +
    "<li>" +
    '<p class="selector-title main-title st-main-title"><b>Layout </b>Customizer</p>' +
    '<span class="text-muted">Live customizer with tools of options</span>' +
    "</li>" +
    "<li>" +
    ...
    '<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sel-layout" role="tab">Layout colors</a></li>' +
    "</ul>" +
